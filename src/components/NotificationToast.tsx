...
const NotificationToast = (props: ToastProps) => {
  ...
  const removeTxnNotification = useMCStore((s) => s.removeTxnNotification);
  const handleClose = () => {
  ...
  return (
    <div
      id='toast-success'
      className='z-[1000] mb-3 flex w-[340px] items-center rounded-lg bg-white p-4 text-gray-500 shadow dark:bg-gray-800 dark:text-gray-400 md:w-[420px]'
      role='alert'>
